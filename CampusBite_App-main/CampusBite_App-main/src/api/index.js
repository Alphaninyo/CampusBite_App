...
export const api = {
  ...
  orders: {
    ...
    updateStatus:        (id, status, pin) => client.patch(`/orders/${id}/status`, { status, pin }),
  ...
  admin: {
    ...
    markRefundComplete: (id)  => client.patch(`/admin/orders/${id}/mark-refund-complete`),
    forceCompleteOrder: (id, reason) => client.patch(`/admin/orders/${id}/force-complete`, { reason }),
