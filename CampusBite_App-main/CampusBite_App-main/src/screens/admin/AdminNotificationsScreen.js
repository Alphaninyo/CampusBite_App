      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySub}>New vendor/courier applications, document submissions, and reported issues will show up here.</Text>
          </View>
        }
        renderItem={({ item }) => (
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              if (item.data?.order_id) {
                navigation.navigate('Orders', { screen: 'OrdersMain', params: { openOrderId: item.data.order_id } });
              }
            }}
            activeOpacity={0.75}
          >
            <View style={[styles.iconBox, { backgroundColor: TYPE_COLOR[item.type] || COLORS.subtext }]}>
...
const styles = StyleSheet.create({
  ...
  body: { fontSize: 13, color: COLORS.subtext, marginBottom: 4, lineHeight: 18 },
  ...
  emptySub: { fontSize: 14, color: COLORS.subtext, marginTop: 4, textAlign: 'center' },
});
