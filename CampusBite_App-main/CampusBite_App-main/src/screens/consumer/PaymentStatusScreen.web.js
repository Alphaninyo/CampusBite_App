...
// Web-only variant: @stripe/stripe-react-native's native SDK (used on iOS/
// Android — see PaymentStatusScreen.native.js) can't bundle for web at all,
// since its package imports native-only RN internals. Opening the existing
// Stripe.js checkout page in a new browser tab is the normal, expected
// pattern for web checkout anyway, so this keeps that flow unchanged.
